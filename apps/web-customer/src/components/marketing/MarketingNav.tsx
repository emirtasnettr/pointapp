  ...
  return (
    <>
      ...
      >
        ...
        >
          <a href={homeUrl} className="flex min-w-0 items-center" style={{ gap: `${0.5 * S}rem` }}>
            {logoUrl ? (
              ...
              <span className="font-bold tracking-tight text-brand" style={{ fontSize: `${1.125 * S}rem` }}>
                Point
              </span>
            )}
          </a>
          ...
          >
            {NAV.map((item) => (
              <a
                key={item.href}
                href={marketingWebPath(item.href)}
        ...
        >
          <div className="relative overflow-hidden border-b border-zinc-200/80 px-5 py-4">
            ...
            <div className="relative flex items-center justify-between gap-3">
              <a href={homeUrl} className="min-w-0" onClick={close}>
                {logoUrl ? (
                  // eslint-disable-next-line @next/next/no-img-element
            ...
            <p className="relative mt-2 text-xs font-medium text-zinc-500">Menü</p>
          </div>
