/**
 * Müşteri web — varsayılan 7201 (tanıtım sitesi 7200 ile yan yana).
 * Örn: WEB_CUSTOMER_PORT=5052 npm run dev
 */
...
const port = process.env.WEB_CUSTOMER_PORT || process.env.PORT || '7201';
