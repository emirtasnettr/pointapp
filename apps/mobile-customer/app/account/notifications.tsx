    ...
    async (next: boolean) => {
      ...
      try {
        ...
        if (next) {
          ...
          if (!perm.granted) {
            setErr(
              'Sistem bildirim izni kapalı. Ayarlardan Point uygulaması için bildirimleri açabilirsiniz.',
            );
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={styles.content}>
      <Text style={styles.lead}>
        Kampanya, duyuru ve teslimat bildirimlerini almak için açın. Kapattığınızda pazarlama
        tercihiniz kaydedilir; sistem iznini cihaz ayarlarından yönetebilirsiniz.
      </Text>
